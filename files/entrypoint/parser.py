...
def parse():
    ...
    notebook_sub_parser = subparsers.add_parser("notebook", add_help=False, parents=[parser])
    notebook_sub_parser.set_defaults(action="notebook")

    lab_sub_parser = subparsers.add_parser("lab", add_help=False, parents=[parser])
    lab_sub_parser.set_defaults(action="lab")
